...
namespace Assets.Cardboard.Legacy.Scripts
{
    ...
    public class CardboardOnGUI : MonoBehaviour {
        ...
        public static bool IsGUIVisible {
            get {
                return isGUIVisible && Cardboard.Scripts.Cardboard.SDK.VRModeEnabled && SystemInfo.supportsRenderTextures;
            }
            set {
                isGUIVisible = value;
            }
        ...
        public static bool Triggered {
            get {
                return !IsGUIVisible && Cardboard.Scripts.Cardboard.SDK.Triggered;
            }
        }
        ...
        public void Create() {
            ...
            RenderTexture stereoScreen = Cardboard.Scripts.Cardboard.SDK.StereoScreen;
        ...
        void LateUpdate() {
            ...
            okToDraw = !Cardboard.Scripts.Cardboard.SDK.VRModeEnabled;
        }
