...
using Assets.Cardboard.Scripts;
using UnityEngine;
...
namespace Assets.Cardboard.Legacy.Scripts
{
    ...
    public class CardboardOnGUIMouse : MonoBehaviour {
        ...
        void LateUpdate() {
            StereoController controller = Cardboard.Scripts.Cardboard.Controller;
            ...
            Cardboard.Scripts.Cardboard.SDK.SetTouchCoordinates(pointerX, Screen.height - pointerY);
